...
// echo "<br/>";
 ...
 // echo"<br/>";
  ...
  $data_csv[]= array($product_url,$dew,$Descripton,$ratingnew,$fba,$fbm,$customer_review,$avr,$Price,$abc);
 }
...
<img src="img/loading.gif" style="max-width: 100%;margin: 0px auto;display: block;"/>
...
setTimeout(function(){window.location.href='scrapping_data.php';},1000); 
</script>
...
<?php 
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var $urll = $urll.substr($urll.indexOf("?") + 1)
           
           $('body').append('<iframe src="get_result2.php?'+$urll+'" id="iframe_page_data_load" style="display:none"></iframe>');
          
            
           var get_iframe = $('#iframe_page_data_load');
           get_iframe.on('load',function(){
        //    alert('loaded');
            if(get_iframe.find('body').text())
            {
               // setTimeout(function(){window.location.href='scrapping_data.php';},1000);                    
                 ...
                 setTimeout(function(){
                    get_iframe.attr('src','get_result2.php?'+$urll); 
